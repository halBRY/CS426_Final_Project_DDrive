// Code provided by Namey5 on unity forms 
// https://discussions.unity.com/t/gradient-glow-shader/163595

Shader "Custom/HitNoteGlow" {
	Properties {
		_Color ("Color", Color) = (1,1,1,1)
		_Size ("Glow Size Multiplier", Range(0,16)) = 4
